# URL to find this file on OpenCV repository: https://github.com/opencv/opencv/tree/master/samples/dnn/face_detector
...
class MetalinkDownloader(object):
    ...
    def download(self, metalink_file):
        ...
        for file_elem in ET.parse(metalink_file).getroot().findall('ml:file', self.NS):
            ...
            fname = '../models/face_detector/' + file_elem.attrib['name']
